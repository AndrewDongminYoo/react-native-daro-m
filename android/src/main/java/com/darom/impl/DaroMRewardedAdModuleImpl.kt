...
internal class DaroMRewardedAdModuleImpl(
  ...
  override fun isRewardedAdReady(adUnitId: String, promise: Promise) {
  ...
  override fun showRewardedAd(adUnitId: String, customData: String?) {
    currentActivity?.let { activity ->
      retrieveAd(adUnitId)?.apply {
        setListener(object : DaroRewardedAdListener {
  ...
  private fun retrieveLoader(adUnitId: String): DaroRewardedAdLoader {
    return loaderMap[adUnitId] ?: DaroRewardedAdLoader(
      context,
  ...
  private fun retrieveAd(adUnitId: String): DaroRewardedAd? {
    return rewardedAdMap[adUnitId]
  }
}

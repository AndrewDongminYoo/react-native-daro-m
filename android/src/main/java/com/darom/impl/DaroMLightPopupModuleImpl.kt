    ...
    override fun setLightPopupAdConfiguration(
        ...
        val newOption =
            DaroLightPopupAdOptions().let {
                it.copy(
                    backgroundColor =
                        parameterMap.getString("backgroundColor")?.toColorInt()
                            ?: it.backgroundColor,
                    containerColor =
                        parameterMap.getString("cardViewBackgroundColor")?.toColorInt()
                            ?: it.containerColor,
                    adMarkLabelTextColor =
                        parameterMap.getString("adMarkLabelTextColor")?.toColorInt()
                    ...
                    ctaBackgroundColor =
                        parameterMap.getString("ctaButtonBackgroundColor")?.toColorInt()
                            ?: it.ctaBackgroundColor,
                    ctaTextColor =
                        parameterMap.getString("ctaButtonTextColor")?.toColorInt()
                            ?: it.ctaTextColor,
                    closeButtonText = parameterMap.getString("closeButtonText") ?: it.closeButtonText,
                    closeButtonColor =
                        parameterMap.getString("closeButtonTextColor")?.toColorInt()
                            ?: it.closeButtonColor,
                )
            }
